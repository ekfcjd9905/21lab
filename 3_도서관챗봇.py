...
# --- 사용자 입력 ---
if user_input := st.chat_input("메시지를 입력하세요 (국립부경대학교 도서관 규정 기반 챗봇)"):
        ...
        messages_for_gpt = [
            {
                "role": "system",
                "content": (
                    "너는 오직 아래 제공된 내용만 바탕으로 답변해야 한다. "
                    "아래 내용에 없는 질문에는 '제가 가진 정보로는 답변할 수 없어요.'라고 말해라.\n\n"
                    f"{BASE_TEXT}"
                )
            }
        ]
